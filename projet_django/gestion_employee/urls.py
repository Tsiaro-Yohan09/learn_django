...
urlpatterns = [
    ...
    path('types_conger/', views.types_conger, name="types_conger"),
    path('demande_conger/<int:id>', views.demande_conges, name='demande_conger'),
    path('liste_conger/', views.liste_conges, name='liste_conger'),
]